...
/**
 * MotorcycleCostingOptions Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MotorcycleCostingOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'motorcycleCostingOptions';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('use_highways', $data ?? [], 1.0);
        ...
        $this->setIfExists('use_trails', $data ?? [], 0.0);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['use_trails']) && ($this->container['use_trails'] > 1)) {
            $invalidProperties[] = "invalid value for 'use_trails', must be smaller than or equal to 1.";
        }

        if (!is_null($this->container['use_trails']) && ($this->container['use_trails'] < 0)) {
            $invalidProperties[] = "invalid value for 'use_trails', must be bigger than or equal to 0.";
        }
    ...
    public function setUseLivingStreets($use_living_streets)
    {
        ...
        if (($use_living_streets > 1)) {
            throw new \InvalidArgumentException('invalid value for $use_living_streets when calling MotorcycleCostingOptions., must be smaller than or equal to 1.');
        }
        if (($use_living_streets < 0)) {
            throw new \InvalidArgumentException('invalid value for $use_living_streets when calling MotorcycleCostingOptions., must be bigger than or equal to 0.');
        }
    ...
    public function setUseFerry($use_ferry)
    {
        ...
        if (($use_ferry > 1)) {
            throw new \InvalidArgumentException('invalid value for $use_ferry when calling MotorcycleCostingOptions., must be smaller than or equal to 1.');
        }
        if (($use_ferry < 0)) {
            throw new \InvalidArgumentException('invalid value for $use_ferry when calling MotorcycleCostingOptions., must be bigger than or equal to 0.');
        }
    ...
    public function setUseRailFerry($use_rail_ferry)
    {
        ...
        if (($use_rail_ferry > 1)) {
            throw new \InvalidArgumentException('invalid value for $use_rail_ferry when calling MotorcycleCostingOptions., must be smaller than or equal to 1.');
        }
        if (($use_rail_ferry < 0)) {
            throw new \InvalidArgumentException('invalid value for $use_rail_ferry when calling MotorcycleCostingOptions., must be bigger than or equal to 0.');
        }
     ...
     * Sets use_highways
     *
     * @param float|null $use_highways A measure of willingness to use highways. Values near 0 attempt to avoid highways and stay on roads with lower speeds, and values near 1 indicate the rider is more comfortable on these roads.
     *
     * @return self
     */
    public function setUseHighways($use_highways)
    {
        ...
        if (($use_highways > 1)) {
            throw new \InvalidArgumentException('invalid value for $use_highways when calling MotorcycleCostingOptions., must be smaller than or equal to 1.');
        }
        if (($use_highways < 0)) {
            throw new \InvalidArgumentException('invalid value for $use_highways when calling MotorcycleCostingOptions., must be bigger than or equal to 0.');
        }
    ...
    public function setUseTolls($use_tolls)
    {
        ...
        if (($use_tolls > 1)) {
            throw new \InvalidArgumentException('invalid value for $use_tolls when calling MotorcycleCostingOptions., must be smaller than or equal to 1.');
        }
        if (($use_tolls < 0)) {
            throw new \InvalidArgumentException('invalid value for $use_tolls when calling MotorcycleCostingOptions., must be bigger than or equal to 0.');
        }
    ...
    public function setUseTracks($use_tracks)
    {
        ...
        if (($use_tracks > 1)) {
            throw new \InvalidArgumentException('invalid value for $use_tracks when calling MotorcycleCostingOptions., must be smaller than or equal to 1.');
        }
        if (($use_tracks < 0)) {
            throw new \InvalidArgumentException('invalid value for $use_tracks when calling MotorcycleCostingOptions., must be bigger than or equal to 0.');
        }
    ...
    public function setTopSpeed($top_speed)
    {
        ...
        if (($top_speed > 252)) {
            throw new \InvalidArgumentException('invalid value for $top_speed when calling MotorcycleCostingOptions., must be smaller than or equal to 252.');
        }
        if (($top_speed < 10)) {
            throw new \InvalidArgumentException('invalid value for $top_speed when calling MotorcycleCostingOptions., must be bigger than or equal to 10.');
        }
    ...
    public function setUseDistance($use_distance)
    {
        ...
        if (($use_distance > 1)) {
            throw new \InvalidArgumentException('invalid value for $use_distance when calling MotorcycleCostingOptions., must be smaller than or equal to 1.');
        }
        if (($use_distance < 0)) {
            throw new \InvalidArgumentException('invalid value for $use_distance when calling MotorcycleCostingOptions., must be bigger than or equal to 0.');
        }
    ...
    public function setClosureFactor($closure_factor)
    {
        ...
        if (($closure_factor > 10)) {
            throw new \InvalidArgumentException('invalid value for $closure_factor when calling MotorcycleCostingOptions., must be smaller than or equal to 10.');
        }
        if (($closure_factor < 1)) {
            throw new \InvalidArgumentException('invalid value for $closure_factor when calling MotorcycleCostingOptions., must be bigger than or equal to 1.');
        }
     ...
     * @return float|null
     */
    public function getUseTrails()
    {
        return $this->container['use_trails'];
    }

    /**
     * Sets use_trails
     *
     * @param float|null $use_trails A measure of the rider's sense of adventure. Values near 0 attempt to avoid highways and stay on roads with potentially unsuitable terrain (trails, tracks, unclassified, or bad surfaces), and values near 1 will tend to avoid major roads and route on secondary roads.
     *
     * @return self
     */
    public function setUseTrails($use_trails)
    {
        if (is_null($use_trails)) {
            throw new \InvalidArgumentException('non-nullable use_trails cannot be null');
        }

        if (($use_trails > 1)) {
            throw new \InvalidArgumentException('invalid value for $use_trails when calling MotorcycleCostingOptions., must be smaller than or equal to 1.');
        }
        if (($use_trails < 0)) {
            throw new \InvalidArgumentException('invalid value for $use_trails when calling MotorcycleCostingOptions., must be bigger than or equal to 0.');
        }

        $this->container['use_trails'] = $use_trails;

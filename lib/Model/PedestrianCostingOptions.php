...
class PedestrianCostingOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'type' => '\OpenAPI\Client\Model\PedestrianType',
        'max_distance' => 'int',
        'max_grade' => 'int',
        'mode_factor' => 'float',
        'elevator_penalty' => 'int'
    ];
    ...
    protected static $setters = [
        ...
        'max_grade' => 'setMaxGrade',
        'mode_factor' => 'setModeFactor',
        'elevator_penalty' => 'setElevatorPenalty'
    ];
    ...
    protected static $getters = [
        ...
        'max_grade' => 'getMaxGrade',
        'mode_factor' => 'getModeFactor',
        'elevator_penalty' => 'getElevatorPenalty'
    ];
    ...
    {
        $this->setIfExists('walking_speed', $data ?? [], 5.1);
        ...
        $this->setIfExists('max_grade', $data ?? [], null);
        $this->setIfExists('mode_factor', $data ?? [], 1.5);
        $this->setIfExists('elevator_penalty', $data ?? [], 5);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['walking_speed']) && ($this->container['walking_speed'] < 0.5)) {
            $invalidProperties[] = "invalid value for 'walking_speed', must be bigger than or equal to 0.5.";
        }
        ...
        if (!is_null($this->container['max_grade']) && ($this->container['max_grade'] > 90)) {
            $invalidProperties[] = "invalid value for 'max_grade', must be smaller than or equal to 90.";
        }

        if (!is_null($this->container['max_grade']) && ($this->container['max_grade'] < 0)) {
            $invalidProperties[] = "invalid value for 'max_grade', must be bigger than or equal to 0.";
        }
     ...
     * Sets walking_speed
     *
     * @param float|null $walking_speed Walking speed in kph.
     *
     * @return self
     */
    public function setWalkingSpeed($walking_speed)
    {
        ...
        if (($walking_speed < 0.5)) {
            throw new \InvalidArgumentException('invalid value for $walking_speed when calling PedestrianCostingOptions., must be bigger than or equal to 0.5.');
        }
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Model\PedestrianType|null
     */
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Model\PedestrianType|null $type type
     *
     * @return self
     */
     ...
     * Sets max_distance
     *
     * @param int|null $max_distance Maximum total walking distance (in meters). Defaults to 100,000 for foot, 10,000 for wheelchair.
     *
     * @return self
     */
    public function setMaxDistance($max_distance)
    {
        ...
        if (($max_distance < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_distance when calling PedestrianCostingOptions., must be bigger than or equal to 0.');
        }
    ...
    {
        return $this->container['max_grade'];
    }

    /**
     * Sets max_grade
     *
     * @param int|null $max_grade Maximum grade (steepness) as a percentage. Defaults to 90 for foot, 12 for wheelchair.
     *
     * @return self
     */
    public function setMaxGrade($max_grade)
    {
        if (is_null($max_grade)) {
            throw new \InvalidArgumentException('non-nullable max_grade cannot be null');
        }

        if (($max_grade > 90)) {
            throw new \InvalidArgumentException('invalid value for $max_grade when calling PedestrianCostingOptions., must be smaller than or equal to 90.');
        }
        if (($max_grade < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_grade when calling PedestrianCostingOptions., must be bigger than or equal to 0.');
        }

        $this->container['max_grade'] = $max_grade;
     ...
     * @return float|null
     */
    public function getModeFactor()
    {
        return $this->container['mode_factor'];
    }

    /**
     * Sets mode_factor
     *
     * @param float|null $mode_factor A factor that modifies the cost when transitioning between travel modes. Setting this value higher than 1 will avoid walking, while setting it lower than 1 will prefer walking.
     *
     * @return self
     */
    public function setModeFactor($mode_factor)
    {
        if (is_null($mode_factor)) {
            throw new \InvalidArgumentException('non-nullable mode_factor cannot be null');
        }
        $this->container['mode_factor'] = $mode_factor;

        return $this;
    }

    /**
     * Gets elevator_penalty
     *
     * @return int|null
     */
    public function getElevatorPenalty()
    {
        return $this->container['elevator_penalty'];
    }

    /**
     * Sets elevator_penalty
     *
     * @param int|null $elevator_penalty A penalty (in seconds) for using an elevator.
     *
     * @return self
     */
    public function setElevatorPenalty($elevator_penalty)
    {
        if (is_null($elevator_penalty)) {
            throw new \InvalidArgumentException('non-nullable elevator_penalty cannot be null');
        }
        $this->container['elevator_penalty'] = $elevator_penalty;

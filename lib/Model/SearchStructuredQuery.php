...
/**
 * SearchStructuredQuery Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SearchStructuredQuery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'searchStructuredQuery';
    ...
    */
     ...
     * Sets postalcode
     *
     * @param string|null $postalcode A mail sorting code.
     *
     * @return self
     */
     ...
     * Sets country
     *
     * @param string|null $country A country code in ISO 3116-1 alpha-2 or alpha-3 format.
     *
     * @return self
     */
    ...
    public function setFocusPointLat($focus_point_lat)
    {
        ...
        if (($focus_point_lat > 90)) {
            throw new \InvalidArgumentException('invalid value for $focus_point_lat when calling SearchStructuredQuery., must be smaller than or equal to 90.');
        }
        if (($focus_point_lat < -90)) {
            throw new \InvalidArgumentException('invalid value for $focus_point_lat when calling SearchStructuredQuery., must be bigger than or equal to -90.');
        }
    ...
    public function setFocusPointLon($focus_point_lon)
    {
        ...
        if (($focus_point_lon > 180)) {
            throw new \InvalidArgumentException('invalid value for $focus_point_lon when calling SearchStructuredQuery., must be smaller than or equal to 180.');
        }
        if (($focus_point_lon < -180)) {
            throw new \InvalidArgumentException('invalid value for $focus_point_lon when calling SearchStructuredQuery., must be bigger than or equal to -180.');
        }
    ...
    public function setBoundaryRectMinLat($boundary_rect_min_lat)
    {
        ...
        if (($boundary_rect_min_lat > 90)) {
            throw new \InvalidArgumentException('invalid value for $boundary_rect_min_lat when calling SearchStructuredQuery., must be smaller than or equal to 90.');
        }
        if (($boundary_rect_min_lat < -90)) {
            throw new \InvalidArgumentException('invalid value for $boundary_rect_min_lat when calling SearchStructuredQuery., must be bigger than or equal to -90.');
        }
    ...
    public function setBoundaryRectMaxLat($boundary_rect_max_lat)
    {
        ...
        if (($boundary_rect_max_lat > 90)) {
            throw new \InvalidArgumentException('invalid value for $boundary_rect_max_lat when calling SearchStructuredQuery., must be smaller than or equal to 90.');
        }
        if (($boundary_rect_max_lat < -90)) {
            throw new \InvalidArgumentException('invalid value for $boundary_rect_max_lat when calling SearchStructuredQuery., must be bigger than or equal to -90.');
        }
    ...
    public function setBoundaryRectMinLon($boundary_rect_min_lon)
    {
        ...
        if (($boundary_rect_min_lon > 180)) {
            throw new \InvalidArgumentException('invalid value for $boundary_rect_min_lon when calling SearchStructuredQuery., must be smaller than or equal to 180.');
        }
        if (($boundary_rect_min_lon < -180)) {
            throw new \InvalidArgumentException('invalid value for $boundary_rect_min_lon when calling SearchStructuredQuery., must be bigger than or equal to -180.');
        }
    ...
    public function setBoundaryRectMaxLon($boundary_rect_max_lon)
    {
        ...
        if (($boundary_rect_max_lon > 180)) {
            throw new \InvalidArgumentException('invalid value for $boundary_rect_max_lon when calling SearchStructuredQuery., must be smaller than or equal to 180.');
        }
        if (($boundary_rect_max_lon < -180)) {
            throw new \InvalidArgumentException('invalid value for $boundary_rect_max_lon when calling SearchStructuredQuery., must be bigger than or equal to -180.');
        }
    ...
    public function setBoundaryCircleLat($boundary_circle_lat)
    {
        ...
        if (($boundary_circle_lat > 90)) {
            throw new \InvalidArgumentException('invalid value for $boundary_circle_lat when calling SearchStructuredQuery., must be smaller than or equal to 90.');
        }
        if (($boundary_circle_lat < -90)) {
            throw new \InvalidArgumentException('invalid value for $boundary_circle_lat when calling SearchStructuredQuery., must be bigger than or equal to -90.');
        }
    ...
    public function setBoundaryCircleLon($boundary_circle_lon)
    {
        ...
        if (($boundary_circle_lon > 180)) {
            throw new \InvalidArgumentException('invalid value for $boundary_circle_lon when calling SearchStructuredQuery., must be smaller than or equal to 180.');
        }
        if (($boundary_circle_lon < -180)) {
            throw new \InvalidArgumentException('invalid value for $boundary_circle_lon when calling SearchStructuredQuery., must be bigger than or equal to -180.');
        }

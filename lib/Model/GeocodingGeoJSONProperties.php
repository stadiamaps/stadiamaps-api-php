...
/**
 * GeocodingGeoJSONProperties Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GeocodingGeoJSONProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'geocodingGeoJSONProperties';
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'accuracy' => 'string',
        'addendum' => '\OpenAPI\Client\Model\GeocodingGeoJSONPropertiesAddendum',
        'continent' => 'string',
    ...
    protected static $setters = [
        ...
        'county' => 'setCounty',
        'county_gid' => 'setCountyGid',
        'region' => 'setRegion',
        'region_a' => 'setRegionA',
        'region_gid' => 'setRegionGid',
        'localadmin' => 'setLocaladmin',
        'localadmin_gid' => 'setLocaladminGid',
    ...
    protected static $getters = [
        ...
        'county' => 'getCounty',
        'county_gid' => 'getCountyGid',
        'region' => 'getRegion',
        'region_a' => 'getRegionA',
        'region_gid' => 'getRegionGid',
        'localadmin' => 'getLocaladmin',
        'localadmin_gid' => 'getLocaladminGid',
    ...
    public const MATCH_TYPE_INTERPOLATED = 'interpolated';
    public const MATCH_TYPE_FALLBACK = 'fallback';
    ...
    public function getMatchTypeAllowableValues()
    {
        return [
            ...
            self::MATCH_TYPE_INTERPOLATED,
            self::MATCH_TYPE_FALLBACK,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('country_a', $data ?? [], null);
        ...
        $this->setIfExists('county_gid', $data ?? [], null);
        $this->setIfExists('region', $data ?? [], null);
        $this->setIfExists('region_a', $data ?? [], null);
        $this->setIfExists('region_gid', $data ?? [], null);
        $this->setIfExists('localadmin', $data ?? [], null);
        $this->setIfExists('localadmin_gid', $data ?? [], null);
    ...
    */
     ...
     * Sets gid
     *
     * @param string|null $gid A scoped GID for this result. This can be passed to the place endpoint. Note that these are not always stable long-term.
     *
     * @return self
     */
     ...
     * Sets layer
     *
     * @param string|null $layer The data layer containing the place (e.g. \"address\" or \"venue\").
     *
     * @return self
     */
     ...
     * Sets source
     *
     * @param string|null $source The ID of the data source that the result came from.
     *
     * @return self
     */
     ...
     * Gets addendum
     *
     * @return \OpenAPI\Client\Model\GeocodingGeoJSONPropertiesAddendum|null
     */
     ...
     * Sets addendum
     *
     * @param \OpenAPI\Client\Model\GeocodingGeoJSONPropertiesAddendum|null $addendum addendum
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getCountryA()
    {
        return $this->container['country_a'];
    }

    /**
     * Sets country_a
     *
     * @param string|null $country_a The ISO 3166-1 alpha-3 code for the country the place is located in.
     *
     * @return self
     */
    public function setCountryA($country_a)
    {
        if (is_null($country_a)) {
            throw new \InvalidArgumentException('non-nullable country_a cannot be null');
        }
        $this->container['country_a'] = $country_a;
     ...
     * Sets country_code
     *
     * @param string|null $country_code The ISO 3166-1 alpha-2 code for the country the place is located in.
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getCountyGid()
    {
        return $this->container['county_gid'];
    }

    /**
     * Sets county_gid
     *
     * @param string|null $county_gid county_gid
     *
     * @return self
     */
    public function setCountyGid($county_gid)
    {
        if (is_null($county_gid)) {
            throw new \InvalidArgumentException('non-nullable county_gid cannot be null');
        }
        $this->container['county_gid'] = $county_gid;
     ...
     * Sets region_a
     *
     * @param string|null $region_a The abbreviation for the region (e.g. PA for the US state of Pennsylvania).
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getRegionGid()
    {
        return $this->container['region_gid'];
    }

    /**
     * Sets region_gid
     *
     * @param string|null $region_gid region_gid
     *
     * @return self
     */
    public function setRegionGid($region_gid)
    {
        if (is_null($region_gid)) {
            throw new \InvalidArgumentException('non-nullable region_gid cannot be null');
        }
        $this->container['region_gid'] = $region_gid;
     ...
     * Sets localadmin
     *
     * @param string|null $localadmin In many countries, this is the lowest level of government. Sometimes interchangeable with locality.
     *
     * @return self
     */
    public function setLocaladmin($localadmin)
    {
        if (is_null($localadmin)) {
            throw new \InvalidArgumentException('non-nullable localadmin cannot be null');
        }
     ...
     * @return string|null
     */
    public function getLocaladminGid()
    {
        return $this->container['localadmin_gid'];
    }

    /**
     * Sets localadmin_gid
     *
     * @param string|null $localadmin_gid localadmin_gid
     *
     * @return self
     */
    public function setLocaladminGid($localadmin_gid)
    {
        if (is_null($localadmin_gid)) {
            throw new \InvalidArgumentException('non-nullable localadmin_gid cannot be null');
        }
        $this->container['localadmin_gid'] = $localadmin_gid;
     ...
     * Sets match_type
     *
     * @param string|null $match_type For search and structured search results, the type of match.
     *
     * @return self
     */
     ...
     * Sets confidence
     *
     * @param float|null $confidence The level of confidence that the result matches what the user searched for. Only available on forward geocoding endpoints.
     *
     * @return self
     */
    public function setConfidence($confidence)
    {
        ...
        if (($confidence > 1)) {
            throw new \InvalidArgumentException('invalid value for $confidence when calling GeocodingGeoJSONProperties., must be smaller than or equal to 1.');
        }
        if (($confidence < 0)) {
            throw new \InvalidArgumentException('invalid value for $confidence when calling GeocodingGeoJSONProperties., must be bigger than or equal to 0.');
        }

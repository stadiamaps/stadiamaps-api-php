...
/**
 * OsrmWaypoint Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OsrmWaypoint implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'osrmWaypoint';
    ...
    */
    ...
    public function setLocation($location)
    {
        ...
        if ((count($location) > 2)) {
            throw new \InvalidArgumentException('invalid value for $location when calling OsrmWaypoint., number of items must be less than or equal to 2.');
        }
        if ((count($location) < 2)) {
            throw new \InvalidArgumentException('invalid length for $location when calling OsrmWaypoint., number of items must be greater than or equal to 2.');
        }
     ...
     * Sets distance
     *
     * @param float $distance The distance of the snapped point from the original location.
     *
     * @return self
     */

...
/**
 * MapMatchWaypoint Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MapMatchWaypoint implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mapMatchWaypoint';
    ...
    */
    ...
    public function setLat($lat)
    {
        ...
        if (($lat > 90)) {
            throw new \InvalidArgumentException('invalid value for $lat when calling MapMatchWaypoint., must be smaller than or equal to 90.');
        }
        if (($lat < -90)) {
            throw new \InvalidArgumentException('invalid value for $lat when calling MapMatchWaypoint., must be bigger than or equal to -90.');
        }
    ...
    public function setLon($lon)
    {
        ...
        if (($lon > 180)) {
            throw new \InvalidArgumentException('invalid value for $lon when calling MapMatchWaypoint., must be smaller than or equal to 180.');
        }
        if (($lon < -180)) {
            throw new \InvalidArgumentException('invalid value for $lon when calling MapMatchWaypoint., must be bigger than or equal to -180.');
        }
     ...
     * Sets time
     *
     * @param int|null $time The timestamp of the waypoint, in seconds. This can inform the map matching algorithm about when the point was measured. A UNIX timestamp, or any increasing integer sequence measuring seconds from some reference point can be used.
     *
     * @return self
     */

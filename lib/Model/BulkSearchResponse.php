...
class BulkSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'status' => 'int',
        'response' => '\OpenAPI\Client\Model\GeocodeResponse',
        'msg' => 'string'
    ];
    ...
    */
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\GeocodeResponse|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\GeocodeResponse|null $response response
     *
     * @return self
     */

...
/**
 * MapMatchRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MapMatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'mapMatchRequest';
    ...
    protected static $openAPITypes = [
        ...
        'durations' => 'int',
        'use_timestamps' => 'bool',
        'trace_options' => '\OpenAPI\Client\Model\MapMatchTraceOptions',
    ...
    protected static $setters = [
        ...
        'use_timestamps' => 'setUseTimestamps',
        'trace_options' => 'setTraceOptions',
    ...
    protected static $getters = [
        ...
        'use_timestamps' => 'getUseTimestamps',
        'trace_options' => 'getTraceOptions',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('use_timestamps', $data ?? [], false);
        $this->setIfExists('trace_options', $data ?? [], null);
        $this->setIfExists('linear_references', $data ?? [], false);
     ...
     * Sets begin_time
     *
     * @param int|null $begin_time The timestamp at the start of the trace. Combined with `durations`, this provides a way to include timing information for an `encoded_polyline` trace.
     *
     * @return self
     */
     ...
     * Sets durations
     *
     * @param int|null $durations A list of durations (in seconds) between each successive pair of points in a polyline.
     *
     * @return self
     */
    ...
    {
        return $this->container['use_timestamps'];
    }

    /**
     * Sets use_timestamps
     *
     * @param bool|null $use_timestamps If true, the input timestamps or durations should be used when computing elapsed time for each edge along the matched path rather than the routing algorithm estimates.
     *
     * @return self
     */
    public function setUseTimestamps($use_timestamps)
    {
        if (is_null($use_timestamps)) {
            throw new \InvalidArgumentException('non-nullable use_timestamps cannot be null');
        }
        $this->container['use_timestamps'] = $use_timestamps;
     ...
     * Gets trace_options
     *
     * @return \OpenAPI\Client\Model\MapMatchTraceOptions|null
     */
    public function getTraceOptions()
    {
        return $this->container['trace_options'];
    }

    /**
     * Sets trace_options
     *
     * @param \OpenAPI\Client\Model\MapMatchTraceOptions|null $trace_options trace_options
     *
     * @return self
     */
    public function setTraceOptions($trace_options)
    {
        if (is_null($trace_options)) {
            throw new \InvalidArgumentException('non-nullable trace_options cannot be null');
        }
        $this->container['trace_options'] = $trace_options;
     ...
     *
     * @param bool|null $linear_references If true, the response will include a `linear_references` value that contains an array of base64-encoded [OpenLR location references](https://www.openlr-association.com/fileadmin/user_upload/openlr-whitepaper_v1.5.pdf), one for each graph edge of the road network matched by the trace.
     *
     * @return self
     */

...
/**
 * AutoCostingOptions Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AutoCostingOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'autoCostingOptions';
    ...
    public function setUseLivingStreets($use_living_streets)
    {
        ...
        if (($use_living_streets > 1)) {
            throw new \InvalidArgumentException('invalid value for $use_living_streets when calling AutoCostingOptions., must be smaller than or equal to 1.');
        }
        if (($use_living_streets < 0)) {
            throw new \InvalidArgumentException('invalid value for $use_living_streets when calling AutoCostingOptions., must be bigger than or equal to 0.');
        }
    ...
    public function setUseFerry($use_ferry)
    {
        ...
        if (($use_ferry > 1)) {
            throw new \InvalidArgumentException('invalid value for $use_ferry when calling AutoCostingOptions., must be smaller than or equal to 1.');
        }
        if (($use_ferry < 0)) {
            throw new \InvalidArgumentException('invalid value for $use_ferry when calling AutoCostingOptions., must be bigger than or equal to 0.');
        }
    ...
    public function setUseRailFerry($use_rail_ferry)
    {
        ...
        if (($use_rail_ferry > 1)) {
            throw new \InvalidArgumentException('invalid value for $use_rail_ferry when calling AutoCostingOptions., must be smaller than or equal to 1.');
        }
        if (($use_rail_ferry < 0)) {
            throw new \InvalidArgumentException('invalid value for $use_rail_ferry when calling AutoCostingOptions., must be bigger than or equal to 0.');
        }
    ...
    public function setUseHighways($use_highways)
    {
        ...
        if (($use_highways > 1)) {
            throw new \InvalidArgumentException('invalid value for $use_highways when calling AutoCostingOptions., must be smaller than or equal to 1.');
        }
        if (($use_highways < 0)) {
            throw new \InvalidArgumentException('invalid value for $use_highways when calling AutoCostingOptions., must be bigger than or equal to 0.');
        }
    ...
    public function setUseTolls($use_tolls)
    {
        ...
        if (($use_tolls > 1)) {
            throw new \InvalidArgumentException('invalid value for $use_tolls when calling AutoCostingOptions., must be smaller than or equal to 1.');
        }
        if (($use_tolls < 0)) {
            throw new \InvalidArgumentException('invalid value for $use_tolls when calling AutoCostingOptions., must be bigger than or equal to 0.');
        }
    ...
    public function setUseTracks($use_tracks)
    {
        ...
        if (($use_tracks > 1)) {
            throw new \InvalidArgumentException('invalid value for $use_tracks when calling AutoCostingOptions., must be smaller than or equal to 1.');
        }
        if (($use_tracks < 0)) {
            throw new \InvalidArgumentException('invalid value for $use_tracks when calling AutoCostingOptions., must be bigger than or equal to 0.');
        }
    ...
    public function setTopSpeed($top_speed)
    {
        ...
        if (($top_speed > 252)) {
            throw new \InvalidArgumentException('invalid value for $top_speed when calling AutoCostingOptions., must be smaller than or equal to 252.');
        }
        if (($top_speed < 10)) {
            throw new \InvalidArgumentException('invalid value for $top_speed when calling AutoCostingOptions., must be bigger than or equal to 10.');
        }
    ...
    public function setUseDistance($use_distance)
    {
        ...
        if (($use_distance > 1)) {
            throw new \InvalidArgumentException('invalid value for $use_distance when calling AutoCostingOptions., must be smaller than or equal to 1.');
        }
        if (($use_distance < 0)) {
            throw new \InvalidArgumentException('invalid value for $use_distance when calling AutoCostingOptions., must be bigger than or equal to 0.');
        }
    ...
    public function setClosureFactor($closure_factor)
    {
        ...
        if (($closure_factor > 10)) {
            throw new \InvalidArgumentException('invalid value for $closure_factor when calling AutoCostingOptions., must be smaller than or equal to 10.');
        }
        if (($closure_factor < 1)) {
            throw new \InvalidArgumentException('invalid value for $closure_factor when calling AutoCostingOptions., must be bigger than or equal to 1.');
        }

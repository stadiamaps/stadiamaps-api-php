...
/**
 * SearchBulkQuery Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SearchBulkQuery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'searchBulkQuery';
    ...
    protected static $openAPITypes = [
        'endpoint' => 'string',
        'query' => '\OpenAPI\Client\Model\SearchQuery'
    ];
    ...
    public const ENDPOINT_V1_SEARCH = '/v1/search';
    ...
    */
     ...
     * Gets query
     *
     * @return \OpenAPI\Client\Model\SearchQuery|null
     */
     ...
     * Sets query
     *
     * @param \OpenAPI\Client\Model\SearchQuery|null $query query
     *
     * @return self
     */

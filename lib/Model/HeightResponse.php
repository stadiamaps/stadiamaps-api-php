 ...
 *
 * @category Class
 * @description Response from the elevation endpoint.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class HeightResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets id
     *
     * @param string|null $id The request identifier, if provided.
     *
     * @return self
     */
     ...
     * Sets shape
     *
     * @param \OpenAPI\Client\Model\Coordinate[]|null $shape The input shape, if provided as coordinates.
     *
     * @return self
     */
    ...
    public function setRangeHeight($range_height)
    {
        if (is_null($range_height)) {
            array_push($this->openAPINullablesSetToNull, 'range_height');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('range_height', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }

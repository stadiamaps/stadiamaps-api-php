...
/**
 * OsrmViaWaypoint Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OsrmViaWaypoint implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'osrmViaWaypoint';
    ...
    {
        $this->setIfExists('distance_from_start', $data ?? [], null);
        $this->setIfExists('geometry_index', $data ?? [], null);
        $this->setIfExists('waypoint_index', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['distance_from_start'] === null) {
            $invalidProperties[] = "'distance_from_start' can't be null";
        }
        if ($this->container['geometry_index'] === null) {
            $invalidProperties[] = "'geometry_index' can't be null";
        }
     ...
     *
     * @param float $distance_from_start The distance from the start of the leg, in meters.
     *
     * @return self
     */
    public function setDistanceFromStart($distance_from_start)
    {
        if (is_null($distance_from_start)) {
            throw new \InvalidArgumentException('non-nullable distance_from_start cannot be null');
        }
     ...
     * Sets geometry_index
     *
     * @param int $geometry_index The index of the waypoint's location in the route geometry.
     *
     * @return self
     */
     ...
     * Sets waypoint_index
     *
     * @param int $waypoint_index The index of the associated waypoint.
     *
     * @return self
     */
    public function setWaypointIndex($waypoint_index)
    {
        if (is_null($waypoint_index)) {
            throw new \InvalidArgumentException('non-nullable waypoint_index cannot be null');
        }

...
class RouteRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'language' => '\OpenAPI\Client\Model\RoutingLanguages',
    ...
    */
     ...
     * Gets language
     *
     * @return \OpenAPI\Client\Model\RoutingLanguages|null
     */
     ...
     * Sets language
     *
     * @param \OpenAPI\Client\Model\RoutingLanguages|null $language language
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\RoutingWaypoint[]|null $exclude_locations This has the same format as the locations list. Locations are mapped to the closest road(s), and these road(s) are excluded from the route path computation.
     *
     * @return self
     */

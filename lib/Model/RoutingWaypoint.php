...
class RoutingWaypoint implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['search_cutoff']) && ($this->container['search_cutoff'] < 0)) {
            $invalidProperties[] = "invalid value for 'search_cutoff', must be bigger than or equal to 0.";
        }
     ...
     * Sets heading
     *
     * @param int|null $heading The preferred direction of travel when starting the route, in integer clockwise degrees from north. North is 0, south is 180, east is 90, and west is 270. Avoid specifying this unless you really know what you're doing. Most use cases for this are better served by `preferred_side`.
     *
     * @return self
     */
     ...
     *
     * @param int|null $street_side_max_distance The max distance in meters that the input coordinates or display lat/lon can be from the edge centerline for them to be used for determining the side of the street. Beyond this distance, no street side is inferred.
     *
     * @return self
     */
     ...
     * Sets search_cutoff
     *
     * @param int|null $search_cutoff A hard cutoff (in meters) for the search distance when matching this location to the road network. This overrides the server default and limits how far from the input coordinate the router will search for candidate edges. Use this sparingly.
     *
     * @return self
     */
    public function setSearchCutoff($search_cutoff)
    {
        ...
        if (($search_cutoff < 0)) {
            throw new \InvalidArgumentException('invalid value for $search_cutoff when calling RoutingWaypoint., must be bigger than or equal to 0.');
        }

...
/**
 * TraceAttributesBaseResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TraceAttributesBaseResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'traceAttributesBaseResponse';
    ...
    */
    ...
    public function setConfidenceScore($confidence_score)
    {
        ...
        if (($confidence_score > 1)) {
            throw new \InvalidArgumentException('invalid value for $confidence_score when calling TraceAttributesBaseResponse., must be smaller than or equal to 1.');
        }
        if (($confidence_score < 0)) {
            throw new \InvalidArgumentException('invalid value for $confidence_score when calling TraceAttributesBaseResponse., must be bigger than or equal to 0.');
        }

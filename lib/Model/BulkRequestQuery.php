...
class BulkRequestQuery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setPointLat($point_lat)
    {
        ...
        if (($point_lat > 90)) {
            throw new \InvalidArgumentException('invalid value for $point_lat when calling BulkRequestQuery., must be smaller than or equal to 90.');
        }
        if (($point_lat < -90)) {
            throw new \InvalidArgumentException('invalid value for $point_lat when calling BulkRequestQuery., must be bigger than or equal to -90.');
        }
    ...
    public function setPointLon($point_lon)
    {
        ...
        if (($point_lon > 180)) {
            throw new \InvalidArgumentException('invalid value for $point_lon when calling BulkRequestQuery., must be smaller than or equal to 180.');
        }
        if (($point_lon < -180)) {
            throw new \InvalidArgumentException('invalid value for $point_lon when calling BulkRequestQuery., must be bigger than or equal to -180.');
        }

...
class MatrixRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets date_time
     *
     * @param \OpenAPI\Client\Model\TimeConstraintV1|null $date_time Time-dependent routing constraint applied globally. Cannot be combined with per-waypoint `date_time` on sources/targets.
     *
     * @return self
     */

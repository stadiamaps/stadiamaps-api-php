...
class LowSpeedVehicleCostingOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setUseRailFerry($use_rail_ferry)
    {
        ...
        if (($use_rail_ferry > 1)) {
            throw new \InvalidArgumentException('invalid value for $use_rail_ferry when calling LowSpeedVehicleCostingOptions., must be smaller than or equal to 1.');
        }
        if (($use_rail_ferry < 0)) {
            throw new \InvalidArgumentException('invalid value for $use_rail_ferry when calling LowSpeedVehicleCostingOptions., must be bigger than or equal to 0.');
        }

...
class MatrixResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'units' => '\OpenAPI\Client\Model\RoutingLongUnits'
    ];
     ...
     * Sets sources
     *
     * @param \OpenAPI\Client\Model\Coordinate[] $sources The list of starting locations determined by snapping to the nearest appropriate point on the road network for the routing profile. All locations appear in the same order as the input.
     *
     * @return self
     */
     ...
     * Sets targets
     *
     * @param \OpenAPI\Client\Model\Coordinate[] $targets The list of ending locations determined by snapping to the nearest appropriate point on the road network for the routing profile. All locations appear in the same order as the input.
     *
     * @return self
     */
     ...
     * Gets units
     *
     * @return \OpenAPI\Client\Model\RoutingLongUnits
     */
     ...
     * Sets units
     *
     * @param \OpenAPI\Client\Model\RoutingLongUnits $units units
     *
     * @return self
     */

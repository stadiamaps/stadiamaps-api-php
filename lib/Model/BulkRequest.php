...
class BulkRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'BulkRequest';
    ...
    public const ENDPOINT_V1_REVERSE = '/v1/reverse';
     ...
     * Gets query
     *
     * @return \OpenAPI\Client\Model\BulkRequestQuery
     */
     ...
     * Sets query
     *
     * @param \OpenAPI\Client\Model\BulkRequestQuery $query query
     *
     * @return self
     */

...
class MotorScooterCostingOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setUseRailFerry($use_rail_ferry)
    {
        ...
        if (($use_rail_ferry > 1)) {
            throw new \InvalidArgumentException('invalid value for $use_rail_ferry when calling MotorScooterCostingOptions., must be smaller than or equal to 1.');
        }
        if (($use_rail_ferry < 0)) {
            throw new \InvalidArgumentException('invalid value for $use_rail_ferry when calling MotorScooterCostingOptions., must be bigger than or equal to 0.');
        }
    ...
    public function setUseDistance($use_distance)
    {
        ...
        if (($use_distance > 1)) {
            throw new \InvalidArgumentException('invalid value for $use_distance when calling MotorScooterCostingOptions., must be smaller than or equal to 1.');
        }
        if (($use_distance < 0)) {
            throw new \InvalidArgumentException('invalid value for $use_distance when calling MotorScooterCostingOptions., must be bigger than or equal to 0.');
        }
    ...
    public function setClosureFactor($closure_factor)
    {
        ...
        if (($closure_factor > 10)) {
            throw new \InvalidArgumentException('invalid value for $closure_factor when calling MotorScooterCostingOptions., must be smaller than or equal to 10.');
        }
        if (($closure_factor < 1)) {
            throw new \InvalidArgumentException('invalid value for $closure_factor when calling MotorScooterCostingOptions., must be bigger than or equal to 1.');
        }

...
class MatrixWaypoint implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets date_time
     *
     * @param string|null $date_time Optional departure time for this specific waypoint in `YYYY-MM-DDTHH:MM` format. On matrix requests, per-waypoint date_time drives time-dependent routing behavior (e.g., accounting for traffic conditions at different times for different origins). Cannot be combined with a root-level `date_time`.
     *
     * @return self
     */

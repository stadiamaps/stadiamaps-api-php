    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['locations']) > 1)) {
            $invalidProperties[] = "invalid value for 'locations', number of items must be less than or equal to 1.";
        }
    ...
    public function setLocations($locations)
    {
        ...
        if ((count($locations) > 1)) {
            throw new \InvalidArgumentException('invalid value for $locations when calling IsochroneRequest., number of items must be less than or equal to 1.');
        }
        if ((count($locations) < 1)) {
            throw new \InvalidArgumentException('invalid length for $locations when calling IsochroneRequest., number of items must be greater than or equal to 1.');
        }

...
class TraceEdge implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets speed_limit
     *
     * @param int|null $speed_limit The speed limit along the edge measured in `units`/hr. This may be either an integer or the string \"unlimited\" if speed limit data is available. If absent, there is no speed limit data available.
     *
     * @return self
     */

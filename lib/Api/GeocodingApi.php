...
class GeocodingApi
{
     ...
     * @param  string $boundary_gid The GID of an area to limit the search to. (optional)
     * @param  \OpenAPI\Client\Model\GeocodingLayer[] $layers A list of layers to limit the search to. (optional)
     * @param  \OpenAPI\Client\Model\GeocodingSource[] $sources A list of sources to limit the search to. (optional)
     ...
     *
     * @param  \OpenAPI\Client\Model\BulkRequest[] $bulk_request bulk_request (optional)
     ...
     * Quickly run a batch of geocoding queries against the search or structured search endpoints.
     *
     * @param  \OpenAPI\Client\Model\BulkRequest[] $bulk_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['searchBulk'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
